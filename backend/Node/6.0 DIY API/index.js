...
app.get("/jokes/:id", (req, res) => {
  ...
  var result = jokes.find(item => item.id === searchId);
  res.json(result);
});
...
app.get("/filter", (req, res) => {
  ...
  var result = jokes.filter(i => i.jokeType.toLowerCase() == term );
  res.json(result);
});
//4. POST a new joke
app.post("/jokes", (req, res) => {
  ...
  console.log(newJoke)
  jokes.push(newJoke)
  res.json("Joke added successfully");
});
//5. PUT a joke
